This project is a React-based notes application developed as part of a comparative study of modern frontend frameworks. The application allows users to create, edit, delete, search, and filter notes. All data is stored locally in the browser. 
...
To run the application locally, Node.js and npm must be installed on the system. The node_modules folder is  not included in the repository and must be installed locally.
